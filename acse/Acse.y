...
either_or_statement :   EITHER
                        {
                            ...
                            $1.label_either = newLabel(program);
                            $1.label_or = newLabel(program);
                            $1.label_exp = newLabel(program);
                            $1.label_end = newLabel(program);

                            gen_bt_instruction(program, $1.label_exp, 0);

                            assignLabel(program, $1.label_either);    //l_either
                        }
                        code_block OR
                        {
                            gen_bt_instruction(program, $1.label_end, 0);

                            assignLabel(program, $1.label_or);            //l_or
                        }
                        code_block ON
                        {
                            gen_bt_instruction(program, $1.label_end, 0);

                            assignLabel(program, $1.label_exp);          //l_exp
                        }
                        exp
                        {
                            //exp? *l_either : *l_or
                            ...
                            assignLabel(program, $1.label_end);          //l_end
                        }
    ;
